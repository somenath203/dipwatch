...
export async function sendPriceDropAlert(userEmail, product, currentPriceInWebsiteRightNow, priceStoredInDB) {
  try {
    ...
    const { data, error } = await resend.emails.send({
      ...
      to: userEmail,
      subject: `🎉 Price Drop Alert: ${product?.full_name_of_the_product}`,
      html: `
  <!DOCTYPE html>
  <html>
    <head>
    ...
    >
      ...
      >
        ${
          product?.image_url_of_the_scraped_product
            ? `
              <div style="text-align: center; margin-bottom: 20px;">
                <img
                  src="${product?.image_url_of_the_scraped_product}"
                  alt="${product?.full_name_of_the_product}"
                  style="
                    max-width: 200px;
                    height: auto;
                    border-radius: 8px;
        ...
        >
          <p style="margin: 0; font-size: 14px; color: #92400e;">
            <strong>
              Good news! The price has dropped by ${priceDropInPercentage}%.
            </strong>
          </p>
        </div>
        ...
        <table style="width: 100%; margin: 20px 0;">
          <tr>
            ...
            >
              ...
              <div
                ...
                "
              >
                ${product?.currency} ${priceStoredInDB?.toFixed(2)}
              </div>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 10px;">
              ...
              >
                ${product?.currency}
                ${currentPriceInWebsiteRightNow?.toFixed(2)}
              </div>
            </td>
          </tr>
        ...
        <div style="text-align: center; margin: 30px 0;">
          <a
            href="${product?.url_of_the_scraped_product}"
            style="
